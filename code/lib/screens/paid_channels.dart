...
class PaidChannelScreen extends StatefulWidget {
  @override
  _PaidChannelScreenState createState() => _PaidChannelScreenState();
}

class _PaidChannelScreenState extends State<PaidChannelScreen> {
